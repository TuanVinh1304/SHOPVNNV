				...
				<div class="row">
					...
					<div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
						<div class="post-entry">
							<a href="#" class="post-thumbnail"><img src="furni-1.0.0/images/post-1.jpg" alt="Image" class="img-fluid"></a>
				...
				<div class="row">
					<div class="col-lg-8">
						<div class="subscription-form">
							<h3 class="d-flex align-items-center"><span class="me-1"><img src="furni-1.0.0/images/envelope-outline.svg" alt="Image" class="furni-1.0.0/img-fluid"></span><span>Subscribe to Newsletter</span></h3>
